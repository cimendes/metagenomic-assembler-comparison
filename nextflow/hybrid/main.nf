...
//      Fasta - ONT
if (params.nanopore instanceof Boolean){exit 1, "'nanopore' must be a path pattern. Provide value:'$params.nanopore'"}
if (!params.nanopore){ exit 1, "'nanopore' parameter missing"}
IN_nanopore_raw = Channel.fromFilePairs(params.nanopore, size: 1).ifEmpty { exit 1, "No nanopore files provided with pattern:'${params.nanopore}'" }
